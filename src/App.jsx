  ...
  return (
    <style>{`
      ...
      *{ box-sizing:border-box; }
      ...
      .sp{ flex:1; }
      .chip{ padding:7px 10px; border-radius:999px; border:1px solid var(--border); background:var(--sky); color:var(--text); font-weight:900; font-size:12px; }
...
export default function App() {
  ...
  // Navigation
  const [tab, setTab] = useState(() => localStorage.getItem("ft_tab") || "team"); // home|league|interests|team
  ...
  const myRow = useMemo(() => (me ? teamsByUser.get(me.id) : null), [teamsByUser, me]);
    ...
    <>
      ...
      <div className="top">
        <div className="topin">
          ...
          <div className="sp" />
          {playersLoading ? <div className="chip">ADP…</div> : null}
          {me ? <div className="chip">{me.email}</div> : null}
          {me ? (
            ...
            <div className="card" style={{ background: "var(--sky)" }}>
              <div className="grid2">
                ...
                <div style={{ display: "grid", gap: 10 }}>
                  ...
                  <div className="row">
                    <button onClick={saveMyProfile}>Guardar perfil</button>
...
function Home({ me, myOutgoing, myIncoming, teamsByUser, playerMetaById }) {
  ...
  return (
    <div className="grid2" style={{ marginTop: 12 }}>
      <div className="card">
        <h3 style={{ marginTop: 0 }}>Lo que me interesa</h3>
        {myOutgoing.length === 0 ? (
              ...
              .map((x) => {
                ...
                return (
                  <div key={x.key} className="item">
                    ...
                    <div className="pill">{INTEREST_LABEL[x.level] || x.level}</div>
                  </div>
                );
              })}
          </div>
...
function League({ me, teams, interests, onSetInterest }) {
